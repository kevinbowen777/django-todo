...
The django-todo_ project is a web to-do  application built using the Django 5.0.x web application framework and is part of the collection of `Web Framework Projects`_ assembled by Kevin Bowen.
